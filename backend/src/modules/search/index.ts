...
import { searchGeocodeRoutes } from "./routes/geocode.routes.js";
import { studentJobsRoutes } from "./routes/student-jobs.routes.js";
import { searchTestsRoutes } from "./routes/tests.routes.js";
...
export default async function searchModule(app: FastifyInstance) {
  ...
  app.register(searchGeocodeRoutes, { prefix: "/api/v3" });
  app.register(studentJobsRoutes, { prefix: "/api/v3" });
  app.register(searchTestsRoutes, { prefix: "/api/v3" });
}
