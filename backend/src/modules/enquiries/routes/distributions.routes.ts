// Distribution routes — business inbox, list-only. Business scoping follows the
// existing convention (requireBusinessContext resolves req.auth.orgId and sets
// req.db to the tenant-scoped Knex via tenant.plugin.ts, requirePermission gates
// the action) rather than a :businessId URL param.
