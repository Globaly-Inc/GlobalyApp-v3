...
import { institutionLookupRoutes } from "./routes/institution-lookup.routes.js";
import { siteUrlsRoutes } from "./routes/site-urls.routes.js";
...
export default async function dataExtractionModule(app: FastifyInstance) {
  ...
  app.register(institutionLookupRoutes);
  app.register(siteUrlsRoutes);
}
