...
// Institution twin of business/20260824_001_service_details_family.ts — course fees / intakes /
// eligibility / study options / study units / accreditations, scoped to `service_id` on the
// institution's own `business_services` table (see 20260916_001_institution_services.ts).
