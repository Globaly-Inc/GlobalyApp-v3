...
// Same-to-same reuse of the data-extraction "Create Intake" form (intakes-tab.tsx's IntakeForm) —
// same PartialDateInput fields, trimmed of course-linking (a service intake belongs to one service).
