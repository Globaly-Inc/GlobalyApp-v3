...
export function ThreadPanel({
  ...
  const threads = useAppSelector((s) => s.businessMessages.threads);
  const replies = useAppSelector((s) => s.businessMessages.repliesByParent[parentId]) ?? [];
  const status = useAppSelector((s) => s.businessMessages.repliesStatus[parentId]) ?? "idle";
