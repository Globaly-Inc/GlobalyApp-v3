...
import { Building2, Check, ChevronDown, GraduationCap, Plus } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
...
export type SwitcherOrg = AuthMeBusiness & { kind?: "business" | "institution" };
            ...
            <DropdownMenuItem key={b.org_id} className="cursor-pointer gap-2" onClick={() => onSwitch(b.org_id)}>
              ...
              <span className="flex-1 min-w-0">
                ...
                <span className="block truncate text-xs text-muted-foreground capitalize">
                  {b.kind === "institution" ? `Institution · ${b.role}` : b.role}
                </span>
              </span>
