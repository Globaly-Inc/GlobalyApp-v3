 ...
 *
 * Run: node --experimental-strip-types src/app/personal/messages/utils/self-check.ts
...
import type { EnquiryMessage } from "../apis/types.ts";
...

{
  const text = conversationToText(
    { business_name: "Sydney Study Agents", course_name: "BSc Computer Science" },
    [
