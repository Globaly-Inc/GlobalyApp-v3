...
export function FreeListingCta() {
  return (
    <section className="py-16 bg-[hsl(187,92%,96%)]">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <Reveal direction="right">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              ...
              {/* A deep cyan, not --gold: the accent aqua is tuned to sit on the navy
                  sections and only reaches ~1.7:1 on this pale wash. */}
              <span className="text-[hsl(193,96%,26%)]">FREE for a Limited Time 🎉</span>
            </h2>
