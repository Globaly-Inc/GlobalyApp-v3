...
import { MockupBadge, MockupCard, MockupFrame, MockupInput } from "./mockup-frame";
    ...
    <MockupFrame label="globaly.app / search">
      <div className="space-y-4">
        <div className="relative animate-fade-in" style={{ animationDelay: "0ms", animationFillMode: "both" }}>
          ...
          <MockupInput value="Masters in Computer Science abroad" className="pl-9" />
        </div>
          ...
          {RESULTS.map((r, i) => (
            ...
            >
              ...
              <div className="hidden sm:flex flex-col items-end gap-1 flex-shrink-0">
                <MockupBadge variant="secondary" className="text-[10px]">
                  {r.tag}
                </MockupBadge>
