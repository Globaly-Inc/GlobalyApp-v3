    ...
    <MockupFrame label="business portal / enquiries">
      <div className="space-y-3">
        ...
        <div className="relative">
          ...
          {/* Unlocked state — fades in over the same space */}
          <MockupCard
          ...
          >
            ...
            <Badge className="bg-primary/10 text-primary border-0 text-[10px]">Interested in MSc CS · Canada</Badge>
          </MockupCard>
        </div>
      </div>
    </MockupFrame>
