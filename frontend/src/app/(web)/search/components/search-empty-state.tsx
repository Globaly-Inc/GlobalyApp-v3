...
export function SearchEmptyState({ name, clearHref = "/search" }: Readonly<{ name: string; clearHref?: string }>) {
  return (
    <div className="text-center py-20">
      ...
      <Link href={clearHref} className="text-sm text-primary hover:underline">Clear filters</Link>
    </div>
  );
}
